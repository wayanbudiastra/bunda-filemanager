    ...
    <div class="p-6 relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div class="px-4 py-3 mt-4 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Nama Dokument Katagori</span>
                <input name="nama_dokument_jenis" wire:model.defer="nama_dokument_jenis"
                    ...
                    placeholder="Nama Dokument Katagori" />
                    @error('nama_dokument_jenis')
